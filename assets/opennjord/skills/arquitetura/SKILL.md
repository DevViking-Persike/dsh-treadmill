...
- Registre cada resposta como `## DN` (atual × alvo, alternativas, trade-offs e
  decisão).
- Registre somente decisões materiais existentes; não invente decisões para atingir uma quantidade mínima.
...
> o 10b consome/julga esse resultado, não o refaz. Sem impacto estrutural ou divergência do design aprovado, registre uma ratificação breve referenciando a revisão 25; não repita análise ou testes já válidos.
